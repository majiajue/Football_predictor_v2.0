...
def scrap_last_update():
    ...
    engine = create_engine('mysql://root:Rudeboys28@footballpredictorrds.cxof60cybzv9.eu-west-1.rds.amazonaws.com/test77')
    dbConnection = engine.connect()
    with engine.connect() as conn, conn.begin():
        df.to_sql('teams_ratings', conn, if_exists='replace')
